...
<body>
    <div class="lecture-container">
        ...
        <div class="lecture-form">
            <h2><i class="fas fa-video"></i> Upload New Lecture</h2>
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="4" placeholder="Enter lecture description"></textarea>
                </div>
        ...
        <div class="lecture-form">
            <h2><i class="fas fa-list"></i> Existing Lectures</h2>
                            ...
                            <div class="lecture-info">
                                ...
                                <div class="lecture-meta">
                                    <span>
                                        ...
                                        <?php echo date('M d, Y', strtotime($lecture['upload_date'])); ?>
                                    </span>
                                </div>
                            </div>
                            <div class="lecture-actions">
                                <a href="view_lecture.php?id=<?php echo $lecture['id']; ?>" class="btn-small btn-view">
                                    <i class="fas fa-play-circle"></i> View
                                </a>
                                <a href="edit_lecture.php?id=<?php echo $lecture['id']; ?>" class="btn-small btn-edit">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <button class="btn-small btn-danger" onclick="deleteLecture(<?php echo $lecture['id']; ?>)">
